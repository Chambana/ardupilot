...
const AP_Param::Info Copter::var_info[] = {
    ...
    // @Param: THROW_FREEFALL_DISTANCE
    // @DisplayName: Meters to Freefall after Airdrop started
    // @Description: Used by THROW mode. Following a downward throw ("drop"), Copter will freefall for this many meters before engaging motors and stabilizing
    // @Units: Meters
    // @Values: 0 32767
    // @User: Standard
    GSCALAR(throw_freefall_distance, "THROW_FREEFALL_DISTANCE", 0),
